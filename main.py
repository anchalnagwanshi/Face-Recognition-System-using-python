...
class Face_Recognisation_system:
    def __init__(self,root):
        ...
        #student button
        img4 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        b1_1=Button(bg_img,text="Student Details",cursor="hand2",font=("times new roman",15,"bold"),bg="grey",fg="black")
        b1_1.place(x=120,y=280,width=180,height=40)

        #detect face button
        img5 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        b1_1=Button(bg_img,text="Face Detector",cursor="hand2",font=("times new roman",15,"bold"),bg="grey",fg="black")
        b1_1.place(x=420,y=280,width=180,height=40)

        #Attendence button
        img6 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        #help button
        img7 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        b1_1=Button(bg_img,text="Help",cursor="hand2",font=("times new roman",15,"bold"),bg="grey",fg="black")
        b1_1.place(x=1020,y=280,width=180,height=40)

        #train button
        img8 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        b1_1=Button(bg_img,text="Train Data",cursor="hand2",font=("times new roman",15,"bold"),bg="grey",fg="black")
        b1_1.place(x=120,y=530,width=180,height=40)

        #photos button
        img9 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        b1_1=Button(bg_img,text="Photos",cursor="hand2",font=("times new roman",15,"bold"),bg="grey",fg="black")
        b1_1.place(x=420,y=530,width=180,height=40)

        #Developer button
        img10 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
        ...
        #exit button
        img11 = Image.open(r"C:\Users\91942\Desktop\face recognisation system\images\background.jpg")
